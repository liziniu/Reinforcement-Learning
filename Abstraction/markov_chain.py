...
l1 = tf.layers.dense(s, 20, activation=tf.nn.sigmoid, kernel_initializer=tf.random_normal_initializer(1, 1.0))
...
print(result)
plt.figure()
plt.scatter(result[:, 0], result[:, 1], c=['red', 'red', 'blue', 'blue'])
plt.title('Low Dimension Presentation of State')
plt.show()
